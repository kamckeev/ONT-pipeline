...
QUERY="/rs1/researchers/c/ccgoller/wwconsulting/SCRIPTS/outputs/6_scaffolding/SampleA_v2/ragtag.scaffold.fasta"
#REF="/rs1/researchers/c/ccgoller/wwconsulting/SCRIPTS/outputs/3_assembly/SampleB_v2/HiFiasm_B_v2_assembly.p_ctg.fa"
...
delta-filter -l 10000 -i 98 ${PREFIX}.delta > ${PREFIX}.filtered.delta
